...
import {
  closeAddEmployeeCard,
  openAddEmployeeCard,
} from "../../../../redux/slices/addEmployeeSlice.js";
import { useSelector, useDispatch } from "react-redux";
export default function AddEmployee() {
  const activeAddEmployeeCard = useSelector(
    (state) => state.addEmployee.activeAddEmployeeCard
  );
  console.log(activeAddEmployeeCard);
  ...
  return (
    <>
      ...
      <div class="flex justify-center m-5">
        <button
          onClick={() => dispatch(openAddEmployeeCard())}
          ...
          <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
              ...
              <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                ...
                <button
                  onClick={() => dispatch(closeAddEmployeeCard())}
                  type="button"
